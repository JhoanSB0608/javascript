    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "clients") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="client_3" text="3. Obten un listado con el nombre de cada cliente y el nombre y apellido de su representante de ventas."></my-details>
                ...
                <my-details logic="client_7" text="7. Devuelve el nombre de los clientes que no hayan hecho pagos y el nombre de sus representantes junto con la ciudad de la oficina a la que pertenece el representante."></my-details>
                <my-details logic="client_8" text="8. Lista la dirección de las oficinas que tengan clientes en Fuenlabrada."></my-details>
                <my-details logic="client_9" text="9. Devuelve el nombre de los clientes y el nombre de sus representantes junto con la ciudad de la oficina a la que pertenece el representante."></my-details>
                <my-details logic="client_11" text="10. Devuelve un listado que muestre solamente los clientes que no han realizado ningún pago."></my-details>
                <my-details logic="client_12" text="11. Devuelve un listado que muestre solamente los clientes que no han realizado ningún pedido."></my-details>
                <my-details logic="client_13" text="12. Devuelve un listado que muestre los clientes que no han realizado ningún pago y los que no han realizado ningún pedido."></my-details>
                <my-details logic="client_14" text="13. Devuelve un listado con los clientes que han realizado algún pedido pero no han realizado ningún pago."></my-details>
            `
        }
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="employ_2" text="2. Devuelve el nombre del puesto, nombre, apellidos y email del jefe de la empresa."></my-details>
                ...
                <my-details logic="employ_8" text="8. Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado junto con los datos de la oficina donde trabajan."></my-details>
                <my-details logic="employ_9" text="9. Devuelve un listado que muestre los empleados que no tienen una oficina asociada y los que no tienen un cliente asociado."></my-details>
                <my-details logic="employ_12" text="10. Devuelve un listado con los datos de los empleados que no  tienen clientes asociados y el nombre de su jefe asociado"></my-details>
            `;
        }
        if (e.target.innerHTML == "gama") {
            report__details.innerHTML = /*html*/`
                <my-details logic="client_10" text="1. Devuelve un listado de las diferentes gamas de producto que ha comprado cada cliente."></my-details>
            `
        }
        if (e.target.innerHTML == "offices") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="office_3" text="3. Lista la dirección de las oficinas que tengan clientes en Fuenlabrada."></my-details>
            `
        }
        if (e.target.innerHTML == "payments") {
            report__details.innerHTML = /*html*/`
                <my-details logic="payment_1" text="1. Devuelve un listado con el código de cliente de aquellos clientes que realizaron algún pago en 2008. Tenga en cuenta que deberá eliminar aquellos códigos de cliente que aparezcan repetidos. "></my-details>
                <my-details logic="payment_2" text="2. Devuelve un listado con todos los pagos que se realizaron en el año 2008 mediante Paypal. Ordene el resultado de mayor a menor."></my-details>
                <my-details logic="payment_3" text="3. Devuelve un listado con todas las formas de pago que aparecen en la tabla pago. Tenga en cuenta que no deben aparecer formas de pago repetidas."></my-details>
            `
        }
        ...
        if (e.target.innerHTML == "requests") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="request_6" text="6. Devuelve el nombre de los clientes a los que no se les ha entregado a tiempo un pedido."></my-details>
            `
        }
    })
})
