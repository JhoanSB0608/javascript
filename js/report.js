    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "clients") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="client_6" text="3. Devuelve el nombre de los clientes y el nombre de sus representantes junto con la ciudad de la oficina a la que pertenece el representante."></my-details>
                <my-details logic="client_16" text="4. Devuelve un listado con todos los clientes que sean de la ciudad de Madrid y cuyo representante de ventas tenga el código de empleado 11 o 30."></my-details>
                <my-details logic="client_1" text="5.Obtén un listado con el nombre de cada cliente y el nombre y apellido de su representante de ventas."></my-details>
                <my-details logic="client_2" text="6. Muestra el nombre de los clientes que hayan realizado pagos junto con el nombre de sus representantes de ventas."></my-details>
                <my-details logic="client_3" text="7. Muestra el nombre de los clientes que **no** hayan realizado pagos junto con el nombre de sus representantes de ventas."></my-details> 
                <my-details logic="client_4" text="8.Devuelve el nombre de los clientes que han hecho pagos y el nombre de sus representantes junto con la ciudad de la oficina a la que pertenece el representante."></my-details>
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="employ_6" text="6. Devuelve un listado con los datos de los empleados que no  tienen clientes asociados y el nombre de su jefe asociado"></my-details>
            `;
        }
        if (e.target.innerHTML == "gama") {
            report__details.innerHTML = /*html*/`
                <my-details logic="gama_1" text="1. Devuelve un listado de las diferentes gamas de producto que ha comprado cada cliente.></my-details>
            `;
        }
